%REG_DSFP	Plotting script for discrete-time regulator simulation.    
...
iflg_=1;
while(opt_),
fprintf('\n\n     -- REG_DSFP -- Full-State-Feedback Regulator Plotting.\n\n');
for i_=1:N_,
...
clear iflg_ N_ m_ bdat_ bg_ bt_ i_ opt_ tx1_ tu1_ tdat_ tg_ tt_ ttt_ tttt_ uu_ tt1_
