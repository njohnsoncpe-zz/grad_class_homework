...
%	ASM(A,B,K) computes and prints the upper and lower gain margins,
%	as well as the phase margin(s) for the loop transfer function
%	described by the state-space matrices (A,B,K).
